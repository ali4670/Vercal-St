...
function ExamPage() {
  ...
  if (alreadyTaken)
    return (
      <div className="min-h-screen bg-[#0a2610] text-white flex items-center justify-center p-6 text-center">
        <div className="bg-black/40 backdrop-blur-2xl border border-white/10 rounded-[48px] p-16 shadow-2xl">
  ...
  return (
    <div className="min-h-screen bg-[#0a2610] text-white p-6 relative overflow-hidden">
