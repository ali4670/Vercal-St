    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#020202] py-20 px-4 md:px-0">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <>
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full bg-black/40 border border-white/5 rounded-3xl py-4 px-8 text-white font-bold placeholder:text-white/5 focus:outline-none focus:border-[#CCFF00]/30 transition-all text-sm ${isAr ? "text-right" : ""}`}
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 p-1.5 bg-black/40 border border-white/5 rounded-[2rem]">
                    <button
                        type="button"
                        onClick={() => setSelectedRole("student")}
                        className={`flex-1 py-4 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest transition-all ${selectedRole === "student" ? "bg-[#CCFF00] text-black shadow-lg" : "text-white/30 hover:text-white"}`}
                    >
                        {t.student}
                    </button>
                    <button
                        ...
                        className={`flex-1 py-4 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest transition-all ${selectedRole === "parent" ? "bg-[#CCFF00] text-black shadow-lg" : "text-white/30 hover:text-white"}`}
                    >
                        {t.parent}
                    </button>
                </div>
          ...
          <div className="space-y-3">
            <label
              className={`block text-[9px] font-black text-white/30 uppercase tracking-[0.3em] px-2 ${isAr ? "text-right" : ""}`}
            >
              {t.email}
            </label>
            <div className="relative group/input">
              <Mail
                className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 text-white/20 group-focus-within/input:text-[#CCFF00] transition-colors ${isAr ? "right-6" : "left-6"}`}
              />
              <input
                type="email"
                required
